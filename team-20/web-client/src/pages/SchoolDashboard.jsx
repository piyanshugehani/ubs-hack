...
export default function VolunteerDashboard() {
  ...
  const [volunteerSlots, setVolunteerSlots] = useState({
    "2025-04-03": [
      { id: 1, name: "Jane Smith", time: "09:00 - 11:00", status: "confirmed", school: "Lincoln Elementary" },
      { id: 2, name: "Mark Johnson", time: "13:00 - 15:00", status: "confirmed", school: "Lincoln Elementary" }
    ],
    "2025-04-04": [
      { id: 3, name: "Emily Chen", time: "10:00 - 12:00", status: "pending", school: "Washington High" }
    ],
    "2025-04-05": [
      { id: 4, name: "Robert Davis", time: "09:00 - 11:00", status: "rejected", school: "Roosevelt Middle School" }
    ],
    "2025-04-08": [
      { id: 5, name: "Sarah Williams", time: "14:00 - 16:00", status: "confirmed", school: "Jefferson Academy" }
    ]
  });
